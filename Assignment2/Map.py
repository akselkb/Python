...
class Map_Obj:
    ...
    def fill_critical_positions(self, task):
        ...
        if task == 1:
            ...
            path_to_map = 'Assignment 2/Samfundet_map_1.csv'
        elif task == 2:
            start_pos = [40, 32]
            goal_pos = [8, 5]
            end_goal_pos = goal_pos
            ...
            goal_pos = [6, 32]
            end_goal_pos = goal_pos
            path_to_map = 'Assignment 2/Samfundet_map_2.csv'
        elif task == 4:
            start_pos = [28, 32]
            goal_pos = [6, 32]
            end_goal_pos = goal_pos
            path_to_map = 'Assignment 2/Samfundet_map_Edgar_full.csv'
        elif task == 5:
            start_pos = [14, 18]
            goal_pos = [6, 36]
            end_goal_pos = [6, 7]
    ...
    def show_map(self, map=None):
        ...
        colors = {' # ': (255, 0, 0), ' . ': (215, 215, 215), ' , ': (166, 166, 166), ' : ': (96, 96, 96),
                  ' ; ': (36, 36, 36), ' S ': (255, 0, 255), ' G ': (0, 128, 255), '+': (255, 255, 0)}
